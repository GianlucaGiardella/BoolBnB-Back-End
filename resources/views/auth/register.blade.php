        ...
        <form method="post" action="{{ route('register') }}" class="form_container">
            ...
            <div class="input_container">
                ...
                <input type="email" class="input_field @error('email') is-invalid @enderror" id="email"
                    ...
                    value="{{ old('email') }}" required minlength="8">
                @error('email')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="input_container">
                ...
                <input type="password" class="input_field @error('password') is-invalid @enderror" id="confirmPassword"
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        // Verificare se la conferma password corrisponde alla password inserita prima
